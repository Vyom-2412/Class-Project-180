    ...
    $.ajax({
        ...
        success:function(response){
            ...
            for(let i=0; i<steps.length; i++){
                ...
                else if(instruction.includes("Turn slight right")){
                    image = "slight_right"
                }
                else if(instruction.includes("Turn slight left")){
                    image = "slight_left"
                }
                else if(instruction.includes("Go Straight")){
                    image = "go_/straight"
                }
                if(i>0){
